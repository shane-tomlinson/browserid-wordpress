...
if (!class_exists('MozillaPersona')) {
	class MozillaPersona {
		...
		function Admin_init_action() {
			...
			add_settings_field('browserid_background_color', __('Background color (shown in dialog):', c_bid_text_domain), array(&$this, 'Option_background_color'), 'browserid', 'plugin_main');
