...
/* 
	The browserid.php file is in its own subdirectory so the l10n 
	extraction tools can work on files in a single directory without
	subdirectories.
*/

require_once( dirname(__FILE__) . '/lib/browserid.php');
